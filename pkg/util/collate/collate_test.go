...
func TestGetCollator(t *testing.T) {
	...
	require.IsType(t, &utf8BinPaddingCollator{}, GetCollator("utf8mb4_bin"))
	require.IsType(t, &utf8BinPaddingCollator{}, GetCollator("utf8_bin"))
	...
	require.IsType(t, &utf8BinPaddingCollator{}, GetCollator("default_test"))
	require.IsType(t, &binCollator{}, GetCollatorByID(63))
	require.IsType(t, &utf8BinPaddingCollator{}, GetCollatorByID(46))
	require.IsType(t, &utf8BinPaddingCollator{}, GetCollatorByID(83))
	...
	require.IsType(t, &utf8BinPaddingCollator{}, GetCollatorByID(9999))
